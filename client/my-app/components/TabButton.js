...
export default ({item, accessibilityState, onPress}) => {
    ...
    return (
        ...
        >
            ...
            >
                <Animated.View style={[{width: 50, height: 50, borderRadius: 100,
                position: 'absolute', backgroundColor: '#5F8D4E'}, scaleStyles]}/>
                <Material name={item.icon} color={accessibilityState.selected ? '#fff' : '#5F8D4E'}
                size={28}/>
            </Animated.View>
